...
## after the bed stabilization is almost 0.4795.
...
densSoil=1440.89487155181 # BULK DENSITY FOR SOIL
...
ymport.textClumps("/home/ngoudarzi/Desktop/Ordinary Large Scale Tests/Cutter Blade/Simulations with Calibrated Microparameters/GRC-3PlusLMA-1/Loose/Samples/LSP-GRC3A-B1-A-S1.txt",scale=10,shift=Vector3(0,0,0),material=SoilId,color=Vector3(0.0,1.0,0.0))
...
ymport.textClumps("/home/ngoudarzi/Desktop/Ordinary Large Scale Tests/Cutter Blade/Simulations with Calibrated Microparameters/GRC-3PlusLMA-1/Loose/Samples/LSP-GRC3A-B1-A-S1.txt",scale=10,shift=Vector3(maxX,0,0),material=SoilId,color=Vector3(0.0,1.0,0.0))
...
## USE YOUR OWN LOCAL MACHINE ADDRESS
O.engines=[VTKRecorder(fileName='/home/ngoudarzi/Desktop/Ordinary Large Scale Tests/Cutter Blade/Simulations with Calibrated Microparameters/GRC-3PlusLMA-1/Loose/VTK/LSP-GRC3A-B1-A-S1/LSP-GRC3A-B1-A-S1' ,recorders=['all'],iterPeriod=5000),
...
def history():
  ...
  plot.saveDataTxt('/home/ngoudarzi/Desktop/Ordinary Large Scale Tests/Cutter Blade/Simulations with Calibrated Microparameters/GRC-3PlusLMA-1/Loose/Numerical Output/LSP-GRC3A-B1-A-S1/LSP-GRC3A-B1-A-S1.txt')
